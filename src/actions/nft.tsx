...
import { creatMintManager } from '../solarity/programs'
...
*/
    ...
    const transferAuthority = 'GF8vm4xnizE4Po4LeBJakvo7xrH9MSBo12VTtLgSRv1f';
    const [tinstructions, tokenKey] = await creatMintManager(connection, wallet, mintKey)
    const authorityInstructions = await creatMintManager(connection, wallet, tokenKey, toPublicKey(transferAuthority))
