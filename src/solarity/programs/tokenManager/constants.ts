...
import * as TOKEN_MANAGER_TYPES from "../../idl/tokenManager";

export const TOKEN_MANAGER_ADDRESS = new PublicKey(
  "solr99QFMYByTqGPWmNqunV7vBLmWWXdSrHUfV8Jf3JM"
);
...
export type TOKEN_MANAGER_PROGRAM = TOKEN_MANAGER_TYPES.TokenManager;
